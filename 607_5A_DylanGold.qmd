...
When tidying a data set there are several things we have to do. Specifically we need to recreate the data in a way such that each column is a variable, row is a observation and each cell is a value. \ 
Then we need to count data and some sort of analysis with this, compare percentages and other things shown in the rubric.
...
I will add an extra row name, which is implyed in the data but it would be easier to work with if it already had the row value. \
